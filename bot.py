...
async def keep_alive():
    app_url = os.environ.get("APP_URL", "empty-nelie-dudemusic111-7bcdb8a4.koyeb.app")
...
class Bot(Client):
    ...
    async def start(self):
        try:
            ...
            logging.info("Keep-alive service active, preventing Koyeb sleep...")
    ...
    async def iter_messages(
        ...
        while True:
            ...
            try:
                ...
                logging.error(f"Error in iter_messages: {str(e)}")
