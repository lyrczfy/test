...
async def give_filter(client, message):
    ...
    if await db.get_autofilter(chat_id):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            if AUTH_CHANNEL and not len(links) == 0:
                ...
                ok = await query.message.reply(DELETE_TXT)  # Use 'query.message'
                await asyncio.sleep(300)
                await ok.delete()
                await f.delete()
                await query.message.reply(DELETED_TXT)  # Use 'query.message'
                return
        ...
        async with lock:
            try:
                for file in files:
                    ...
                    deleted += 1
                    if deleted % 20 == 0:
                        await query.message.edit_text(f"<b>Process started for deleting files from DB. {str(deleted)} Files from DB for your query {keyword} !\n\nPlease wait...</b>")
            except Exception as e:
                logger.exception(e)
        ...
        await query.answer("𝗠𝗼𝘃𝗶𝗲 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗙𝗼𝗿𝗺𝗮𝘁:\n• 𝖲𝗈𝗅𝗈 2017\n• 𝖣𝗁𝗈𝗈𝗆 3 𝖧𝗂𝗇𝖽𝗂\n• 𝖪𝗎𝗋𝗎𝗉 𝖪𝖺𝗇𝗇𝖺𝖽𝖺 1080p\n\n𝗦𝗲𝗿𝗶𝗲𝘀 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗙𝗼𝗿𝗺𝗮𝘁:\n• 𝖣𝖺𝗋𝗄 𝗌01\n• 𝖲𝗁𝖾 𝖧𝗎𝗅𝗄 720p\n• 𝖥𝗋𝗂𝖾𝗇𝖽𝗌 S02E14 720p\n\n𝗗𝗼𝗻'𝘁 𝗔𝗱𝗱 𝗨𝘀𝗲𝗹𝗲𝘀𝘀 𝗪𝗼𝗿𝗱 & 𝗦𝘆𝗺𝗯𝗼𝗹𝘀!", show_alert=True)
        ...
        buttons = [[
            InlineKeyboardButton('𝖲𝖾𝗋𝗂𝖾𝗌 𝖦𝗋𝗈𝗎𝗉', url=f"https://t.me/complete_series_group"),
            InlineKeyboardButton('𝖬𝗈𝗏𝗂𝖾𝗌 𝖦𝗋𝗈𝗎𝗉', url=f"https://t.me/Cine_Paradize")
        ], [
            InlineKeyboardButton('𝖴𝗉𝖽𝖺𝗍𝖾 𝖢𝗁𝖺𝗇𝗇𝖾𝗅', url=f"https://t.me/rzxbots"),
            InlineKeyboardButton('𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖦𝗋𝗈𝗎𝗉', url=f"https://t.me/rzxchat")
        ], [
            InlineKeyboardButton('𝖧𝗈𝗆𝖾', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.SURPRISE_TXT.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝖢𝗈𝗇𝗍𝖺𝖼𝗍 𝖠𝖽𝗆𝗂𝗇', url=f"telegram.me/C0NTACT_RBOT")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.DMCA_TXT.format(temp.B_NAME),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
...
async def advantage_spell_chok(msg, sms=None):
    mv_id = msg.id
    mv_rqst = msg.text
    ...
    try:
        ...
        button = [[        
            ...
            InlineKeyboardButton('‼️ 𝖱𝖾𝖺𝗌𝗈𝗇', callback_data='instructions')
        ]]
    ...
    btn.append([InlineKeyboardButton(text="❌ 𝖢𝗅𝗈𝗌𝖾", callback_data=f'spolling#{reqstr1}#close_spellcheck')])
    spell_check_del = await msg.reply_text(
        text="<b>𝖨 𝖢𝗈𝗎𝗅𝖽𝗇'𝗍 𝖥𝗂𝗇𝖽 𝖠𝗇𝗒𝗍𝗁𝗂𝗇𝗀 𝖱𝖾𝗅𝖺𝗍𝖾𝖽 𝖳𝗈 𝖳𝗁𝖺𝗍.🥲\n𝖣𝗂𝖽 𝖸𝗈𝗎 𝖬𝖾𝖺𝗇 𝖠𝗇𝗒 𝖮𝖿 𝖳𝗁𝖾𝗌𝖾?🧐</b>",
        reply_markup=InlineKeyboardMarkup(btn),
        reply_to_message_id=msg.id
    )
    await asyncio.sleep(120)
